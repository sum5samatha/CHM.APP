(function () {
    ...
    function ResidentsService($rootScope, $q, $http, $window) {
        ...
        objResidentsService.GetActiveRoles = getActiveRoles;
        ...
        objResidentsService.GetPhotoRelativeUrl = GetPhotoRelativeUrl;
        ...
        function GetPhotoRelativeUrl(ResidentId) {

            return $http.get($rootScope.ApiPath + 'Residents/GetPhotoRelativeUrl?guidResidentId=' + ResidentId);
        ...
        function GetActivePainMonitoring() {
     
            return $http.get($rootScope.ApiPath + 'Residents/GetActivePainMonitoring');
