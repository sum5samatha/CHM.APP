(function () {
    ...
    ViewResidentController.$inject = ['$rootScope','$q', '$uibModal', '$window', '$filter', '$stateParams', '$location','$sce', 'toastr', 'ResidentsService'];

    function ViewResidentController($rootScope,$q, $uibModal, $window, $filter, $stateParams, $location, $sce, toastr, ResidentsService) {
        var vm = this;

        vm.IsSecondaryReadonly = $rootScope.IsSecondaryRead;
        console.log(vm.IsSecondaryReadonly);
        ...
        //            //To separate mainQuestion and subquestion 
        ...
        //            //To add subQuestion To MainQuestion 
        ...
        //            //Code to make Groupof Questions as set
        ...
        //            if (AnswerText != '-')
        //                answers[i].Sections_Questions1[j].AnswerText = '-';
        //            else
        //                answers[i].Sections_Questions1[j].AnswerText = false;
        //            for (var k = 0; k < lstAssessmentData.length; k++) {
        ...
        //                        if (answers[i].Sections_Questions1[j].AnswerText == '-') {
        //                            answers[i].Sections_Questions1[j].AnswerText = " ";
        //                        }

        //                        answers[i].Sections_Questions1[j].AnswerText += ($filter('filter')(answers[i].Sections_Questions1[j].Sections_Questions_Answers, { ID: lstAssessmentData[k].ResidentQuestionAnswer.Section_Question_AnswerID })[0].LabelText) + ",";
        ...
        //                        if (lstAssessmentData[k].ResidentQuestionAnswer.AnswerText != null) {
        //                            answers[i].Sections_Questions1[j].AnswerText = lstAssessmentData[k].ResidentQuestionAnswer.AnswerText;
        //                        }

        //                        if (lstAssessmentData[k].ResidentFile != null) {
        //                            answers[i].Sections_Questions1[j].ChosenAnswer = lstAssessmentData[k].ResidentFile;
        //                            var filename = lstAssessmentData[k].ResidentFile.split('/');
        //                            answers[i].Sections_Questions1[j].AnswerText = filename[5];
        //                        }
        ...
        //                    }
        //                }
        //                ViewSubQuestionsAndAnswers(answers[i].Sections_Questions1[j].Sections_Questions_Answers, lstAssessmentData, answers[i].Sections_Questions1[j].AnswerText);
        //            }
        //        }
        ...
        //Code tht sectionquestion1 is changed to childquestion
        //code for childquestion in section_Question_answer
        ...
        //Code for childquestion in section_question 
        //var ViewSubchildQuestionAndAnswers = function (answers, lstAssessmentData, AnswerText) {


        //    for (var i = 0; i < answers.childQuestion.length; i++) {




        //        if (AnswerText != '-')
        //            answers.childQuestion[i].AnswerText = '-';
        //        else
        //            answers.childQuestion[i].AnswerText = false;
        //        for (var k = 0; k < lstAssessmentData.length; k++) {

        //            if (answers.childQuestion[i].AnswerType == 'CheckBoxList') {


        //                if (answers.childQuestion[i].ID == lstAssessmentData[k].ResidentQuestionAnswer.Sections_Questions_Answers.Section_QuestionID) {

        //                    if (answers.childQuestion[i].AnswerText == '-') {
        //                        answers.childQuestion[i].AnswerText = " ";
        //                    }

        //                    answers.childQuestion[i].AnswerText += ($filter('filter')(answers.childQuestion[i].Sections_Questions_Answers, { ID: lstAssessmentData[k].ResidentQuestionAnswer.Section_Question_AnswerID })[0].LabelText) + ",";
        ...
        //                    if (lstAssessmentData[k].ResidentQuestionAnswer.AnswerText != null) {
        //                        answers.childQuestion[i].AnswerText = lstAssessmentData[k].ResidentQuestionAnswer.AnswerText;
        //                    }

        //                    if (lstAssessmentData[k].ResidentFile != null) {
        //                        answers.childQuestion[i].ChosenAnswer = lstAssessmentData[k].ResidentFile;
        //                        var filename = lstAssessmentData[k].ResidentFile.split('/');
        //                        answers.childQuestion[i].AnswerText = filename[5];
        //                    }
        ...
        //                }
        //            }
        //            //if (answers.childQuestion[i].MinScore == null)
        //            //    ViewSubQuestionsAndAnswers(answers.childQuestion[i].Sections_Questions_Answers, lstAssessmentData, answers.childQuestion[i].AnswerText);
        //            //else
        //           //   ViewSubchildQuestionAndAnswers(answers.childQuestion[i], lstAssessmentData, answers.childQuestion[i].AnswerText);
        //        }
        //    }
        ...
        //    var res = objSectionQuestion.replace("ResidentName", vm.Resident.NickName);
        //    return res;
        //}
        ...
        vm.BindSectionQuestion = function (objSectionQuestion, depth) {
         ...
         vm.BindSectionQuestionAnswer = function (objSectionQuestionAnswer) {
             ...
             if (objSectionQuestionAnswer != undefined) {
                 var res = objSectionQuestionAnswer.replace("ResidentName", vm.Resident.NickName);
                 return res;
             }
        }
    }
