(function () {
    ...
    UsersListController.$inject = ['$q', '$sce', '$uibModal', '$window', '$filter', '$stateParams', 'SweetAlert', 'toastr', 'UsersService', 'ngTableParams', '$scope'];

    function UsersListController($q, $sce, $uibModal, $window, $filter, $stateParams, SweetAlert, toastr, UsersService, ngTableParams, $scope) {
