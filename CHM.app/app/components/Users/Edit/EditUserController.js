(function () {
    ...
    EditUserController.$inject = ['$q', '$sce', '$uibModal', '$location', '$window', '$filter', '$stateParams', 'toastr', 'UsersService', 'ResidentsService'];

    function EditUserController($q, $sce, $uibModal, $location, $window, $filter, $stateParams, toastr, UsersService, ResidentsService) {
        var vm = this;
